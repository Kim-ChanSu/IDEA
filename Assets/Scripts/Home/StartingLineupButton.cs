...
public class StartingLineupButton : MonoBehaviour
{
    private int characterNum;

    public void InitializeStartingLineupButton(int index)
    {
        characterNum = index;
    ...
    { 
        GameManager.instance.homeManager.DeselectPlayerRosterButton(characterNum);
    }
}
